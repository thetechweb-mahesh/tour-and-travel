                                                    ...
                                                    <div class="tab-content mt-3" id="productTabsContent">
                                                        ...
                                                        <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info-tab">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="ckeditor form-control" name="details" id="details" rows="5"></textarea>
                                                            </div>
                                                            ...
                                                            <div class="row">   <div class="col-md-6">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" name="meta[key]" id="meta[key]">
                                                                    </div> </div>
                                                            </div>
                                                                
                                                                <div class="form-group">
                                                                    <label for="meta_description">Meta Description</label>
                                                                    <textarea class="form-control" name="meta[description]" id="meta[description]" rows="5"></textarea>
                                                                </div>
